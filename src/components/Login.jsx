...
document.body.style.overflow = 'hidden';
 ...
 return()=>{
  ...
  return (
    ...
    <div className='border px-6 my-4 py-2 flex items-center gap-2 rounded-full mt-4'>
        <img src="" alt="" />
...
<img onClick={()=>setShowLogin(false)} src={assets.cross} alt="X" className='absolute top-5 right-5 cursor-pointer' width={18} />
      </motion.form>
    </div>
  )
}
